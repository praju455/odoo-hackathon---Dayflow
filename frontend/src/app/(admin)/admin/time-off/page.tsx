...
const mockAdminTimeOffData = [
  { sel: false, name: "Emma Johansson", dept: "Engineering", type: "Annual Leave", dates: "Dec 20 - Dec 30, 2025", duration: "8 days", status: "APPROVED", statusTx: "--green-700", req: "Dec 01, 2025", tier: { bg: "--green-50", tx: "--green-700" } },
  { sel: false, name: "Ethan Wilson", dept: "Sales", type: "Sick Leave", dates: "Nov 15 - Nov 16, 2025", duration: "2 days", status: "APPROVED", statusTx: "--green-700", req: "Nov 15, 2025", tier: { bg: "--green-50", tx: "--green-700" } },
  { sel: true, name: "Isabella Hernandez", dept: "Design", type: "Personal", dates: "Oct 10, 2025", duration: "1 day", status: "PENDING", statusTx: "--amber-700", req: "Oct 05, 2025", tier: { bg: "--amber-50", tx: "--amber-700" } },
  { sel: true, name: "William Lee", dept: "Product", type: "Annual Leave", dates: "Jan 05 - Jan 10, 2026", duration: "5 days", status: "PENDING", statusTx: "--amber-700", req: "Dec 10, 2025", tier: { bg: "--amber-50", tx: "--amber-700" } },
];
    ...
    <div className="flex flex-col min-w-0 pb-[100px]">
      <div className="kpi-scroll-container flex border-b border-[var(--border-default)]" style={{ height: "112px" }}>
        <div className="flex w-full min-w-[1160px]">
          <div className="relative flex-shrink-0" style={{ width: "290px", height: "111px" }}>
            <div className="absolute top-[19.8px] left-[20.8px] text-body-medium text-secondary">Total Requests</div>
            <div className="absolute top-[53px] left-[20.8px] flex items-center gap-2">
              <span className="text-kpi-value text-primary">124</span>
              <div className="flex items-center rounded-[7px] px-2 h-[26px]" style={{ backgroundColor: "var(--bg-canvas)" }}>
                <span className="text-label-score text-secondary">This Year</span>
              </div>
            </div>
          </div>
          <div className="relative flex-shrink-0 border-l border-[var(--border-default)]" style={{ width: "290px", height: "111px" }}>
            ...
            <div className="absolute top-[53px] left-[20.8px] flex items-center gap-2">
              <span className="text-kpi-value text-primary">23</span>
              <div className="flex items-center rounded-[7px] px-2 h-[26px]" style={{ backgroundColor: "var(--amber-50)" }}>
                <span className="text-label-score" style={{ color: "var(--amber-700)" }}>Needs Review</span>
              </div>
            </div>
          </div>
          <div className="relative flex-shrink-0 border-l border-[var(--border-default)]" style={{ width: "290px", height: "111px" }}>
            <div className="absolute top-[19.8px] left-[20.8px] text-body-medium text-secondary">Rejected</div>
            <div className="absolute top-[53px] left-[20.8px] flex items-center gap-2">
          ...
          <div className="relative flex-shrink-0 border-l border-[var(--border-default)] flex-1" style={{ minWidth: "290px", height: "111px" }}>
            <div className="absolute top-[19.8px] left-[20.8px] text-body-medium text-secondary">Upcoming Leave</div>
            <div className="absolute top-[53px] left-[20.8px] flex items-center gap-2">
              ...
              <div className="flex items-center rounded-[7px] px-2 h-[26px]" style={{ backgroundColor: "var(--green-50)" }}>
                <span className="text-label-score" style={{ color: "var(--green-700)" }}>This Week</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="tabs-scroll-container flex border-b border-[var(--border-default)] relative" style={{ height: "55px" }}>
        <div className="flex items-center h-full min-w-[1160px] pl-[20px]">
          <div className="flex items-center h-full text-label-tab text-secondary whitespace-nowrap" style={{ padding: "0 22.45px 0 24.8px" }}>All Requests</div>
          <div className="flex items-center h-full relative" style={{ padding: "0 14px 0 16.6px" }}>
            <span className="text-label-tab text-primary whitespace-nowrap">Pending</span>
            <div className="w-[4.4px]" />
            <div className="flex items-center justify-center rounded-[7px] bg-field-on-canvas w-[37px] h-[26px]">
              <span className="text-label-score text-secondary">23</span>
            </div>
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-primary" />
          </div>
          <div className="flex items-center h-full text-label-tab text-secondary whitespace-nowrap" style={{ padding: "0 21.5px 0 22.45px" }}>Approved</div>
        </div>
      </div>
        ...
        <table className="w-full text-left table-fixed table-min-width" style={{ borderCollapse: "collapse" }}>
          ...
          <thead>
            <tr style={{ height: "33px", borderBottom: "1px solid var(--border-default)" }}>
              ...
              <th scope="col" className="text-body-regular text-secondary font-normal p-0">Dates</th>
          ...
          <tbody>
            {mockAdminTimeOffData.map((row, i) => (
              <tr key={i} className="group hover:bg-sidebar transition-colors" style={{ height: "61.5px", borderBottom: "1px solid var(--border-default)" }}>
                ...
                <td className="p-0 text-body-regular text-secondary truncate pr-2">{row.dates}</td>
